...
public final class AnalyticsViewModel_Factory implements Factory<AnalyticsViewModel> {
  ...
  public AnalyticsViewModel_Factory(Provider<ReportRepository> reportRepositoryProvider) {
  ...
  public static AnalyticsViewModel_Factory create(
    ...
    return new AnalyticsViewModel_Factory(reportRepositoryProvider);
  }

  public static AnalyticsViewModel newInstance(ReportRepository reportRepository) {
    return new AnalyticsViewModel(reportRepository);
  }
}
